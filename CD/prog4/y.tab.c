...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from cd4b.y  */
...
const int YY_parse_CLASS::EXP=261;
const int YY_parse_CLASS::SPACE=262;
...
static const short yyprhs[] = {     0,
     0,     2,     7,    10,    11,    15,    19,    23,    26,    28,
    30,    32,    34,    37,    40,    43,    46,    50,    52,    56,
    61
};

static const short yyrhs[] = {    19,
     0,     4,    21,    25,    20,     0,     5,    25,     0,     0,
     8,    22,     9,     0,     6,    23,     6,     0,     6,    23,
     3,     0,     6,    24,     0,     7,     0,    10,     0,    11,
     0,    12,     0,    12,    10,     0,    11,    10,     0,    13,
    13,     0,    14,    14,     0,    15,    25,    16,     0,    19,
     0,    22,    17,    25,     0,    22,    17,     7,    19,     0,
     0
};
...
static const short yyrline[] = { 0,
    10,    12,    14,    15,    17,    19,    20,    21,    22,    24,
    24,    24,    24,    24,    26,    26,    28,    29,    30,    31,
    32
};

static const char * const yytname[] = {   "$","error","$illegal.","NUM","IF",
"ELSE","EXP","SPACE","'('","')'","'='","'<'","'>'","'+'","'-'","'{'","'}'","';'",
"S","F","EL","H","E","Z","U","B",""
};
#endif
...
static const short yydefact[] = {     0,
     0,     1,     0,    21,     0,     9,     0,    21,    18,     0,
     4,    10,    11,    12,     0,     0,     0,     8,     5,     0,
    21,    21,     2,    14,    13,    15,    16,     7,     6,    17,
     9,    19,     3,    20,     0,     0,     0
};
...
static const short yypact[] = {    -1,
    15,-32768,     5,    -2,     8,-32768,     7,    -2,-32768,     9,
    19,-32768,    17,    18,    12,    16,     4,-32768,-32768,    13,
     2,    -2,-32768,-32768,-32768,-32768,-32768,-32768,-32768,-32768,
    -1,-32768,-32768,-32768,    32,    33,-32768
};

static const short yypgoto[] = {-32768,
     0,-32768,-32768,    31,-32768,-32768,    -7
};
...
static const short yytable[] = {     2,
    20,     1,     1,     5,     6,     1,    28,     5,    31,    29,
     5,     6,     8,    32,    33,    19,     8,    12,    13,    14,
    15,    16,     3,    22,    26,    21,    24,    25,    30,    27,
    34,    36,    37,     7
};

static const short yycheck[] = {     0,
     8,     4,     4,     6,     7,     4,     3,     6,     7,     6,
     6,     7,    15,    21,    22,     9,    15,    10,    11,    12,
    13,    14,     8,     5,    13,    17,    10,    10,    16,    14,
    31,     0,     0,     3
};
